...
\item Let $e \in E(i), u \xirghtarrow{e} v, u \in V_{i-1}, v \in V_i$ \\
\begin{itemize}
\item Case 1: $u \xrightarrow{e} v$  
\[ f_{new}(e) = f_{old}(e) + \bar{f}(e) \re 0 \]
\item Case2: $u \xleftarrow{ } v$
\[ f_{new}(e) = f_{old}(e) - \bar{f}(e) \re f_{old}(e) - \bar{c}(e) \overset{Def. \bar{c}}{=} 0 \]
\end{itemize}
\end{enumerate}
